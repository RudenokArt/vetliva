  <?php if (!isset($_GET['filter'])) {
    $_GET['filter'] = 'accomodation';
  }; ?>
  <div class="search_filter">
    <form action="/search/" method="get" id="search_filter-form">
      <div class="search_filter-search">
        <input id='search_input' placeholder="<?php echo GetMessage('search_placeholder');?>"
        ...
        <div class="search_filter-live_search-wrapper" id="search_filter-live_search-wrapper">
          <div id="search_filter-live_search" class="search_filter-live_search"></div>
        </div>
