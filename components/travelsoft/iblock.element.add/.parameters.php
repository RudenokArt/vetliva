	...
	"PARAMETERS" => array(
		...
		"ELEMENT_ASSOC" => array(
			...
			"DEFAULT" => "CREATED_BY",
                                   ...
                                   "IS_EXC_TOUR" => array(
                                       "NAME" => "Заполнение экскурсионного тура",
                                       "TYPE" => "CHECKBOX"
                                   )
	),
);
...
$arComponentParameters["PARAMETERS"]["NAME_TITLE"] = array(
	"PARENT" => "TITLES",
	"NAME" => "Название объекта добавления",
	"TYPE" => "TEXT",
	"DEFAULT" => "Название",
);
$arComponentParameters["PARAMETERS"]["LIST_NAME_TITLE"] = array(
	"PARENT" => "TITLES",
	"NAME" => "Название списка объектов добавления",
	"TYPE" => "TEXT",
	"DEFAULT" => "Мои объекты",
);
?>