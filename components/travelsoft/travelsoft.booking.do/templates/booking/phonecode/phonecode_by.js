    ...
    $.widget('custom.phonecode', {
        ...
        _loadData : function() {
            ...
            if(!countryCache && !countryRequesting) {
                countryRequesting = $.getJSON('/local/components/travelsoft/travelsoft.booking.do/templates/booking/phonecode/countries_by.json', {})
                    .done(function(json) {
                        self.data = json;
        ...
        _initSelector: function() {
            ...
            var searchLabel = $('<label class="country-phone-search-label">Увядзіце краіну</label>');
