...
if (
    ...
    foreach ($db_list as $row) {
        ...
        if (isset($detail_info["CHANGE"]["UF_QUOTE"])) {
            ...
            if (is_array($detail_info["CHANGE"]["UF_QUOTE"])) $detail_info["CHANGE"]["UF_QUOTE"]  = $detail_info["CHANGE"]["UF_QUOTE"]['VALUE'];
            if (is_array($detail_info["BEFORE_CHANGE"]["UF_QUOTE"])) $detail_info["BEFORE_CHANGE"]["UF_QUOTE"]  = $detail_info["BEFORE_CHANGE"]["UF_QUOTE"]['VALUE'];
