                            ...
                            foreach ($arr_rates as $arr_rate) {
                                if (in_array($arr_rate["ID"], $arr_rates_id)) {
                                    ...
                                    if (
                                        ...
                                        $this->arResult["SPECIFYING_DATA"]["RATES_RENDER_DATA"]["UF_RF_PRICES"][$arr_rate["ID"]] = $arr_rate["UF_NAME" . POSTFIX_PROPERTY];
                                        $this->arResult["SPECIFYING_DATA"]["RATES_RENDER_DATA"]["UF_BR_PRICES"][$arr_rate["ID"]] = $arr_rate["UF_NAME" . POSTFIX_PROPERTY];
                                        $this->arResult["SPECIFYING_DATA"]["RATES_RENDER_DATA"]["UF_EU_PRICES"][$arr_rate["ID"]] = $arr_rate["UF_NAME" . POSTFIX_PROPERTY];
