...
$MESS["IBLOCK_USER_MESSAGE_ADD_DEFAULT"] = "Благодарим Вас за отзыв, оставленный на портале VETLIVA.RU. Как только Ваше сообщение пройдет модерацию, оно будет опубликовано на сайте. Для вашей следующей покупки на VETLIVA введите промокод «Отзыв» и получите скидку.";
