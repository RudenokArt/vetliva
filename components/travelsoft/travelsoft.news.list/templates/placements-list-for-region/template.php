                    ...
                    <li>
                        <i class="fa fa-info-circle blue"></i> <span class="for-spot-payment"><?= GetMessage('FOR_SPOT_PAYMENT') ?><span>
                            ...
                            if ($arParams["CALCULATION_PRICE_RESULT"][$arItem["ID"]]):
                                ...
                                ?>
                                <?if (!$discount_price):?>
                                <a target="_blank" <? if ($arResult["ID"] == SANATORIUM_IBLOCK_ID): ?>itemprop="url"<? endif ?> href="<? echo getCalculateDetailLink($arItem["DETAIL_PAGE_URL"], $arParams["__BOOKING_REQUEST"], array("scroll-to-sp" => "Y")) ?>" title="">
