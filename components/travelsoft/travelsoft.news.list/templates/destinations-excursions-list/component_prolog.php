...
if (LANGUAGE_ID == "ru") {
    $arSortBy = array(
        ...
        "price" => array(
            "realfield" => "PROPERTY_SORT_BY_PRICE_ASC",
            "order_def" => "asc",
            /*"callback" => array(
...
if (isset($arSortBy[$_REQUEST["sort_by"]])) {
    ...
    if ($_REQUEST['sort_by']=='price' && $_REQUEST['order']=='desc') $arParams["SORT_BY1"] = 'PROPERTY_SORT_BY_PRICE';
    elseif ($_REQUEST['sort_by']=='price' && $_REQUEST['order']=='asc') $arParams["SORT_BY1"] = 'PROPERTY_SORT_BY_PRICE_ASC';
    else $arParams["SORT_BY1"] = $arSortBy[$_REQUEST["sort_by"]]["realfield"];
