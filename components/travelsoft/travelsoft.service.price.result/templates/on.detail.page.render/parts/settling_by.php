                ...
                <div class="row settling-by">
                    <? foreach ($arr_offer["DETAILS"] as $arr_service): ?>
                        <div class="col-md-12 service-info-container">
                            ...
                            <div class="col-md-3">
                                 <?if (count($arr_service["MAIN_BLOCK"]['PICTURES'])>1):?>
                                    <div class="banners-slider-list owl-carousel">
                                    <?foreach ($arr_service["MAIN_BLOCK"]['PICTURES'] as $photo_id):?>
                                                <figure>
    												<img  loading="lazy"  src="<?= getSrcImage($photo_id, array('width' => 400, 'height' => 260)) ?>">
    											</figure>
                                    <?endforeach;?>
                                    </div>
                                    <?else:?>
    										<figure>
    												<img  loading="lazy"  src="<?= getSrcImage($arr_service["MAIN_BLOCK"]["IMAGE_ID"], array('width' => 400, 'height' => 260)) ?>">
    											</figure>
    								<?endif;?>
                                </div>
                            <?$col = 6;endif?>
                            ...
                            <? endif ?>
                            <?if ($arr_service["MAIN_BLOCK"]['UF_PEOPLE']):?>
                                <div class="fsp-container"><span class="for-spot-payment"><?= GetMessage("UF_PEOPLE") ?>: <?=$arr_service["MAIN_BLOCK"]['UF_PEOPLE']?></span></div>
                            <?endif;?>
                            <div class="col-md-12">
                    ...
                    <? endforeach ?>
                    <div class="text-right booking-btn-block">
                        <div class="price-container"><?= GetMessage("TOTAL_BOOKING") ?> <?= travelsoft\booking\Utils::convertCurrency($arr_offer["TOTAL_PRICE"], $current_currency) ?></div>
