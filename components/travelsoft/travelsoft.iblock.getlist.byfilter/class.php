...
class TravelsoftIBlockGetListByFilter extends CBitrixComponent {
     ...
     */
    protected $cacheDir = "/travelsoft/iblock_getlist_byfilter";
    ...
    public function executeComponent() {
        ...
        if ($сache->initCache($this->arParams['CACHE_TIME'], $this->cacheID, $this->cacheDir)) {
            ...
            while ($res = $dbList->GetNextElement()) {
                ...
                $this->arResult["ITEMS"][$cnt] = $FIELDS;
                
                $this->arResult["ITEMS"][$cnt]['PROPERTIES'] = $res->GetProperties(); 
                
                $cnt++;
                
                $this->arResult["ELEMENT_ID"][] = $FIELDS["ID"];
