...
?>
<div class="row form bg-none" style="padding-left:5px">
    <div class="col-md-11">
        <div class="container">
            <?
                            ...
                            <?foreach ($arProperty as $propertyID):?>
                                ...
                                <div class="col-md-<?=$n?> col-lg-<?=$n?>">
                                    <div class="form-field">
                                        <?if (intval($propertyID) > 0 && $arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] != "PERSONAL_DATA_PROCESSING"):?><?=GetMessage($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"])?><?/*=$arResult["PROPERTY_LIST_FULL"][$propertyID]["NAME"]*/?><?else:?><?=!empty($arParams["CUSTOM_TITLE_".$propertyID]) ? $arParams["CUSTOM_TITLE_".$propertyID] : GetMessage("IBLOCK_FIELD_".$propertyID)?><?endif?><?if(in_array($propertyID, $arResult["PROPERTY_REQUIRED"]) && $arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] != "PERSONAL_DATA_PROCESSING"):?><?$required='required';?><span class="starrequired">*</span><br><?endif?>
                                        <?
                                        ...
                                        switch ($INPUT_TYPE):
                                            ...
                                            case "N":
                                                for ($i = 0; $i<$inputNum; $i++)
                                                {
                                                    ...
                                                    ?>
                                                    <input <?=$required?> type="text" name="PROPERTY[<?=$propertyID?>][<?=$i?>]" size="25" value="<?=$value?>" class="field-input<?if($arResult["PROPERTY_LIST_FULL"][$propertyID]["USER_TYPE"] == "Date"):?> date<?endif?><?if ($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "DATE_BIRTH"):?> birthdate<?endif?>" <?if($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "DATE_BIRTH"):?> pattern="^\d{2}\.\d{2}\.\d{4}$"<?endif?>  /><?
                                            ...
                                            case "L":
                                                ...
                                                switch ($type):
                                                    ...
                                                    case "multiselect":
                                                        ...
                                                        <select required name="PROPERTY[<?=$propertyID?>]<?=$type=="multiselect" ? "[]\" size=\"".$arResult["PROPERTY_LIST_FULL"][$propertyID]["ROW_COUNT"]."\" multiple=\"multiple" : ""?>">
