                ...
                <div class="tour-list-item" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                    <figure class="tour-img float-left">
                        <a href="<? echo $arItem["DETAIL_PAGE_URL"] ?>" title="">
                            ...
                            if (!empty($arItem["PREVIEW_PICTURE"])):
                                $an_file = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"], array('width' => 225, 'height' => 150), BX_RESIZE_IMAGE_EXACT, true, array(), false, 80);
                                $pre_photo = $an_file["src"];
                            elseif (!empty($arItem["PROPERTIES"]["PICTURES"]["VALUE"])):
                                $an_file = CFile::ResizeImageGet($arItem["PROPERTIES"]["PICTURES"]["VALUE"][0], array('width' => 225, 'height' => 150), BX_RESIZE_IMAGE_EXACT, true, array(), false, 80);
                                $pre_photo = $an_file["src"];
                            else:
                    ...
                    <div class="tour-text">
                        ...
                        <div class="price-box float-right" Style="cursor: pointer;">
                            <a href="<?= getCalculateDetailLink($arItem["DETAIL_PAGE_URL"], $arParams["__BOOKING_REQUEST"])?>"><?= GetMessage("price_night_title", array("#price#" => $price)); ?></a>
                            </div>
                            <? else: ?>
                            <div class="price-box float-right">
                                <a href="<? echo getCalculateDetailLink($arItem["DETAIL_PAGE_URL"], $arParams["__BOOKING_REQUEST"])?>" title=""><span class="detail"><?= GetMessage("MORE") ?></span></a>
                            </div>
                            <? endif ?>
						<?/*
