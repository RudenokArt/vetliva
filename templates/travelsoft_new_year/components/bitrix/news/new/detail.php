...
<div class="row check-rates">
    ...
    <!--<div class="col-sm-3 hidden-sm hidden-xs col-lg-3 detail-sidebar">
        <div class="scrolly scrollspy-sidebar sidebar-detail scroll-heading" role="complementary">
            <ul class="scrollspy-sidenav">
                <li><h2>Цены</h2></li>
                <li><a href="#block_hd_desc" title="Описание">Описание</a></li>
                <li><a href="#block_services" title="Услуги">Услуги</a></li>
                <li><a href="#block_hd_descroom" title="Номера">Номера</a></li>
                <li><a href="#block_hd_descmeal" title="Питание">Питание</a></li>
                <li><a href="#block_hd_descsport" title="Спорт и отдых">Спорт и отдых</a></li>
                <li><a href="#block_youtube" title="Видео">Видео</a></li>
                <li><a href="#block_map" title="Карта проезда">Карта проезда</a></li>
                <?/*if($USER->GetID() == 1):*/?><li><a href="#block_map" title="Отзывы">Отзывы</a></li><?/*endif*/?>
            </ul>
        </div>
    </div>-->
...
<section class="review-detail detail-cn" id="iblock_detail_reviews">
    <a id="block_detail_reviews" name="block_detail_reviews"></a>
