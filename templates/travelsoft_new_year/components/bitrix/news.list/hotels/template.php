      ...
      <div class="hotel-list-item" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
         ...
         <div class="hotel-text">
            ...
            <address class="hotel-address">
               ...
               <i class="fa fa-map-marker"></i> <?= substr2($arItem["DISPLAY_PROPERTIES"]["ADDRESS".POSTFIX_PROPERTY]["DISPLAY_VALUE"], 200); ?>
            ...
            <?
                        ...
                        <div class="price-box float-right" Style="cursor: pointer;">
                            <a href="<?= $arItem["DETAIL_PAGE_URL"] . $request_string;?>"><?= GetMessage("price_night_title", array("#price#" => $price)); ?></a>
                            </div>
                            <? else: ?>
                            <div class="price-box float-right">
                                <a href="<?= $arItem["DETAIL_PAGE_URL"] . $request_string;?>" title=""><span class="detail"><?= GetMessage("MORE") ?></span></a>
                            </div>
                            <? endif ?>
