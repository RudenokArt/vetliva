					...
					<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="sales-item-a">
						<div class="sales-item">
							...
							<div class="home-sales-text">
                                ...
                                <?if($arItem["IBLOCK_ID"] == PLATFORM_IBLOCK_ID):?>
                                    <address class="hotel-address">
                                        <?if(!empty($arItem["DISPLAY_PROPERTIES"]["ADDRESS".POSTFIX_PROPERTY]["VALUE"])):?>
                                            <i class="fa fa-map-marker"></i> <?=strip_tags($arItem["PROPERTIES"]["ADDRESS".POSTFIX_PROPERTY]["VALUE"])?>
                                        <?endif?>
                                        <?if(!empty($arItem["DISPLAY_PROPERTIES"]["CAPACITY"]["VALUE"])):?>
                                            <br><i class="fa fa-users"></i> <?=getMessage('CAPACITY')?> <?=strip_tags($arItem["PROPERTIES"]["CAPACITY"]["VALUE"])?>
                                        <?endif?>
                                    </address>
                                <?endif?>
