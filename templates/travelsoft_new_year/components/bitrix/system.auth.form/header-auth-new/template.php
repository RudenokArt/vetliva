...
<?if($arResult["FORM_TYPE"] == "login"): ?>
	...
	<?else:?>
	<a href="#log-reg-links" class="log-reg-links"><i class="fa fa-arrow-down" aria-hidden="true"></i></a>
		
		<div id="log-reg-links" class="header-auth-form mfp-hide">
		    <div class="mfp-head"><?= GetMessage("LOGIN_HEAD")?></div>
				<div class="tb">
					<div class="tb-cell">
						<a class="show-header-auth-popup registration-link" href="#header-register-popup">
							<?= GetMessage("REGISTRATION")?>
		...
		<script>				
				$(document).ready(function (){
							$(".log-reg-links").magnificPopup({
								type: "inline",
								mainClass: 'mfp-log-reg',
								midClick: true
							});
...
<?else: ?>
    <a style="color:#337ab7" href="#header-authorized-popup" class="show-header-auth-popup down-mobile-link" title="<?=GetMessage("AUTH_PROFILE")?>"><i class="fa fa-user-circle-o" aria-hidden="true"></i></a>
