...
(function (root, factory) {
    ...
    var MapAdapter = function (options) {
        ...
        var methods = {
            ymaps: {
                loadScript: function () {
                var langapi = defOptions.lang+'_'+defOptions.lang.toUpperCase();
                    __loadScript('https://api-maps.yandex.ru/2.1/?load=package.full&lang='+langapi+'&apikey=b9173d0e-3418-4811-9139-577afbfa0a9b');
                ...
                drawRoute: function (route) {
                    __apply2Map(function () {
                        ...
                        try {
                            ...
                            if (typeof route[0].fullcoord !== 'undefined') { 
                                var multiRoute = new ymaps.multiRouter.MultiRoute({
                                    // Описание опорных точек мультимаршрута.
                                    referencePoints: [route[0].fullcoord, route[1].fullcoord],
