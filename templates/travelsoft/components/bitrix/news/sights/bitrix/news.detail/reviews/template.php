...
<p>
    ...
    if (!empty($arResult["PROPERTIES"]["CITY"]["VALUE"])) {
        $town = strip_tags($arResult["DISPLAY_PROPERTIES"]["CITY"]["DISPLAY_VALUE"]);
        if (LANGUAGE_ID != "ru") {
            $prop = getIBElementProperties($arResult["PROPERTIES"]["CITY"]["VALUE"]);
...
<?endif?>
					<?if(strlen($arResult["PROPERTIES"]["PLUS"]["VALUE"]) > 0 || strlen($arResult["PROPERTIES"]["MINUS"]["VALUE"]) > 0):?>
<div class="review-item">
<div class="review-text">
						<ul>
							<?if(strlen($arResult["PROPERTIES"]["PLUS"]["VALUE"]) > 0):?><li><span class="icon fa fa-plus"></span><?=$arResult["PROPERTIES"]["PLUS"]["VALUE"]?></li><?endif?>
							<?if(strlen($arResult["PROPERTIES"]["MINUS"]["VALUE"]) > 0):?><li><span class="icon icon-minus fa fa-minus"></span><?=$arResult["PROPERTIES"]["MINUS"]["VALUE"]?></li><?endif?>
						</ul>
</div>
</div>
					<?endif?>
