   ...
   <div class="info-list-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>" itemscope <?if($arResult["ID"] == ATTRACTION_IBLOCK_ID || $arResult["ID"] == ACTIONS_IBLOCK_ID):?>itemtype="http://schema.org/Place"<?elseif($arResult["ID"] == NEWS_IBLOCK_ID):?>itemtype="http://schema.org/CreativeWork"<?elseif($arResult["ID"] == POSTER_IBLOCK_ID):?>itemtype="http://schema.org/Event"<?elseif($arResult["ID"] == GETTING_THERE_IBLOCK_ID):?>itemtype="http://schema.org/Thing"<?endif;?>>
            ...
            <div class="banners-slider-list">
                <?for ($i=0; $i<$limit; $i++):?>
                    ...
                    <picture> 
                        ...
                        <?endif;*/?>
                        <img loading="lazy"  itemprop="image" src="<?=$pre_photo?>" alt="<?echo LANGUAGE_ID == "ru" ? $arItem["NAME"] : $arItem["PROPERTIES"]["NAME".POSTFIX_PROPERTY]["VALUE"]?>"/>
                    </picture>                      
                    </a>
                <?endfor;?>
            </div>
      ...
      <div class="info-text" <?if($arResult["ID"] == NEWS_IBLOCK_ID):?>itemprop="description"<?endif?>>
         <div class="info-name" <?if($arResult["ID"] == ATTRACTION_IBLOCK_ID || $arResult["ID"] == POSTER_IBLOCK_ID || $arResult["ID"] == GETTING_THERE_IBLOCK_ID || $arResult["ID"] == ACTIONS_IBLOCK_ID):?>itemprop="name"<?endif?>>
			 <a href="<?echo $arItem["DETAIL_PAGE_URL"]?>#header_name" class="scroll-to" title="" itemprop="url"><?echo LANGUAGE_ID == "ru" ? $arItem["NAME"] : $arItem["PROPERTIES"]["NAME".POSTFIX_PROPERTY]["VALUE"]?></a>
         ...
         <div class="info-star-address">
            <address class="info-address">
				...
				<?if($arParams["DISPLAY_DATE"]!="N"):?>
                    ...
                    ?>
				<?endif;?>
                <?if(($arItem["IBLOCK_ID"] == EVENTS_IBLOCK_ID || $arItem["IBLOCK_ID"]==25) && !empty($arItem["PROPERTIES"]["DATE_FROM"]["VALUE"])):?>
               ...
               <i class="fa fa-map-marker"></i>
                <span itemprop="location" itemscope itemtype="http://schema.org/Place">
                 ...
                 <?if($arItem['DISPLAY_PROPERTIES']['MAP']['VALUE'] && in_array($arItem['IBLOCK_ID'], [30,31,38,5])):?>
                 <?if ($arItem['IBLOCK_ID']==5) $datafiltr = ''; else $datafiltr = \Bitrix\Main\Web\Json::encode($GLOBALS[$arParams['FILTER_NAME']]);?>
...
<?
   ...
   ?>
<div class="search-result <?if(CSite::InDir('/belarus/made-in-belarus/' && '/belarus/getting-there/')):?>made-in-result<?endif;?>">
    <?if ($is_mobile):?>
    <div class="mobile-filtr-sort-block <?if(CSite::InDir('/belarus/made-in-belarus/')):?>made-in-filtr<?endif;?>">
