...
if ($arParams["USE_FILTER"] == "Y"):
    ...
    <div id="filter-area" <?if ($is_mobile):?> class="header-auth-form mfp-hide"<?endif;?>>
...
<?
$APPLICATION->IncludeComponent(
        "travelsoft:travelsoft.news.list", "clinics-list", Array(
    "IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
    "IBLOCK_ID" => $arParams["IBLOCK_ID"],
...
<div class="row">
    <div class="col-sm-9 mrgn-t30" style="float:right;padding-right:25px;">
<?
