...
<div class="bx-authform-social-booking">
    <div class="title-socservice"><?=GetMessage("BTN_SOCSERV_NEW")?></div>
	<ul>
<?
...
?>
		<li class="socserv-wdth">
			<a  class="bx-authform-social-icon <?=$service["ICON"]?>" href="javascript:void(0)" onclick="<?=htmlspecialcharsbx($onclick)?>" title="<?=htmlspecialcharsbx($service["NAME"])?>"></a>
