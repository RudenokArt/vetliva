            ...
            <address class="info-address">
               ...
               <i class="fa fa-map-marker"></i>
                <span itemprop="location" itemscope itemtype="http://schema.org/Place">
                 ...
                 <?if($arItem['DISPLAY_PROPERTIES']['MAP']['VALUE'] && in_array($arItem['IBLOCK_ID'], [30,31,38,5,6])):?>
                 <?if (in_array($arItem['IBLOCK_ID'], [5,6])) $datafiltr = ''; else $datafiltr = \Bitrix\Main\Web\Json::encode($GLOBALS[$arParams['FILTER_NAME']]);?>
