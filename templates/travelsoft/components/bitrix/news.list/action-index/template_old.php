                        ...
                        <figure class="home-sales-img">
                            <? if (($i != 3) & ($i != 4)): ?>
								...
								elseif (!empty($arItem["PROPERTIES"]["PICTURES".POSTFIX_PROPERTY]["VALUE"])):
									$an_file = CFile::ResizeImageGet($arItem["PROPERTIES"]["PICTURES".POSTFIX_PROPERTY]["VALUE"][0], array('width'=>292, 'height'=>180), BX_RESIZE_IMAGE_EXACT, true, array(), false, 80);
									$pre_photo=$an_file["src"];
                            ...
                            <? else: ?>
                                ...
                                if (!empty($arItem["PREVIEW_PICTURE"])):
                                    ...
                                    $pre_photo = $an_file["src"];
								elseif (!empty($arItem["PROPERTIES"]["PICTURES".POSTFIX_PROPERTY]["VALUE"])):
									$an_file = CFile::ResizeImageGet($arItem["PROPERTIES"]["PICTURES".POSTFIX_PROPERTY]["VALUE"][0], array('width'=>584, 'height'=>292), BX_RESIZE_IMAGE_EXACT, true, array(), false, 80);
									$pre_photo=$an_file["src"];
                                elseif (!empty($arItem["PROPERTIES"]["PICTURES"]["VALUE"])):
