		...
		<? foreach ($arResult["ITEMS"] as $arItem): ?>
						...
						<div class="tour-list-item" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
							...
							<div class="tour-text">
								...
								<li>
									<span class="label"><a data-content="<?= GetMessage('TOURS_DATE') ?>" class="border_icon"><img src="<?= SITE_TEMPLATE_PATH ?>/images/icon/calendar.png"></a></span>  <?= GetMessage('TOURS_DATE') ?>: <? echo $arItem["DISPLAY_PROPERTIES"]["TOURS_DATE" . POSTFIX_PROPERTY]["DISPLAY_VALUE"]; ?> <br>
