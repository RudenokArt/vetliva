...
class CIBlockPropertyTinyMCE
{
	const USER_TYPE = 'TinyMCE';
	...
	public static function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName)
	{
        ...
        AddMessage2Log([$arProperty, $value, $strHTMLControlName]);
...
//                    CFileMan::AddHTMLEditorFrame($text_name, htmlspecialcharsBx($ar["TEXT"]), $text_type, mb_strtolower($ar["TYPE"]), $settings['height'], "N", 0, "", "");
				?>
                <script type="text/javascript" src="/bitrix/js/tinymce/tinymce/tinymce.min.js"></script>
                <script type="text/javascript" src="/bitrix/js/tinymce/init.js"></script>
                <textarea class="tinymce" name="<?=$strHTMLControlName["VALUE"]?>" style="width: 100%;"><?=htmlspecialcharsBx($ar["TEXT"])?></textarea>
			</td>
		</tr>
		<?else:?>
		<tr>
